...
vi.mock('@/lib/queries/notifications', () => ({
  useNotifications: (userId: string | undefined) => mockUseNotifications(userId),
}))
...
function setupDefaultMocks() {
  ...
  mockUseMarkAsRead.mockReturnValue({ mutate: mockMarkAsReadMutate, isPending: false })
  mockUseMarkAllAsRead.mockReturnValue({ mutate: mockMarkAllAsReadMutate, isPending: false })
}
...
describe('NotificheContent', () => {
  ...
  it('shows notification body', () => {
    ...
    render(<NotificheContent />, { wrapper })
    expect(screen.getByText('Il turno di lunedì è stato pubblicato.')).toBeInTheDocument()
  })
