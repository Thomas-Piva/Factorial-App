...
export type ShiftType = 'work_shift' | 'rest_day' | 'holiday' | 'transfer' | 'permission'
export type UserRole = 'employee' | 'manager' | 'admin'
export type NotificationType = 'shift_published' | 'absence_approved' | 'communication' | 'new_shift'
...
export type StoreMembership = Database['public']['Tables']['store_membership']['Row']
export type ShiftTemplate = Database['public']['Tables']['shift_template']['Row']
export type ShiftAssignment = Database['public']['Tables']['shift_assignment']['Row']
