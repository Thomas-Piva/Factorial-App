...
describe('eachDayOfInterval', () => {
  it('returns all days in the interval inclusive', () => {
    const days = eachDayOfInterval(new Date('2026-04-01'), new Date('2026-04-03'))
    expect(days.map(toISODate)).toEqual(['2026-04-01', '2026-04-02', '2026-04-03'])
  })

  it('returns single day when start equals end', () => {
    const days = eachDayOfInterval(new Date('2026-04-01'), new Date('2026-04-01'))
